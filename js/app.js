      ...
      card.innerHTML =
        ...
        '<div class="escapada-card__body">' +
          ...
          '<div class="escapada-card__precios">' +
            '<div class="precio-item"><span class="precio-item__label">Precio público p/p HAB DBL</span><span class="precio-item__valor">' + formatoMoneda(esc.precio_publico) + '</span></div>' +
            ...
            '<div class="escapada-card__neto"><span class="label">Neto agencia p/p HAB DBL</span><span class="valor">' + formatoMoneda(esc.neto_agencia) + '</span></div>' +
          '</div>' +
        '</div>';
